...
export default function About() {
  return (
    <section id="about" className="py-24 px-6 bg-gradient-to-b from-[#111827] to-[#1f2937] text-white relative">
      {/* Subtle grid texture */}
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <motion.div
          ...
          className="bg-white/5 backdrop-blur-lg p-10 rounded-2xl border border-white/10 shadow-2xl text-gray-300 leading-relaxed space-y-6"
        >
          <p className="text-lg">
